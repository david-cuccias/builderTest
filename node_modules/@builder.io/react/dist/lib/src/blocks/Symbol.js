...
var builder_page_component_1 = require("../components/builder-page.component");
...
var SymbolComponent = /** @class */ (function (_super) {
    ...
    SymbolComponent.prototype.render = function () {
        ...
        var _a = symbol || {}, model = _a.model, entry = _a.entry, data = _a.data, content = _a.content, inline = _a.inline;
        ...
        return (core_1.jsx(builder_store_1.BuilderStoreContext.Consumer, { key: (model || 'no model') + ':' + (entry || 'no entry') }, function (state) {
            ...
            return (core_1.jsx(TagName, __assign({ "data-model": model }, attributes, { className: (attributes.class || attributes.className || '') +
                    ...
                    ((symbol === null || symbol === void 0 ? void 0 : symbol.dynamic) || _this.props.dynamic ? ' builder-dynamic-symbol' : '') }), showPlaceholder ? (_this.placeholder) : (core_1.jsx(builder_page_component_1.BuilderPage, __assign({ ref: function (ref) { return (_this.ref = ref); }, context: __assign({}, state.context), modelName: model, entry: entry, data: __assign(__assign(__assign({}, data), (!!_this.props.inheritState && state.state)), (_f = (_e = (_d = (_c = (_b = (_a = _this.props.builderBlock) === null || _a === void 0 ? void 0 : _a.component) === null || _b === void 0 ? void 0 : _b.options) === null || _c === void 0 ? void 0 : _c.symbol) === null || _d === void 0 ? void 0 : _d.content) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.state), renderLink: state.renderLink, inlineContent: symbol === null || symbol === void 0 ? void 0 : symbol.inline }, (content && { content: content }), { options: { key: key }, hydrate: (_g = state.state) === null || _g === void 0 ? void 0 : _g._hydrate, builderBlock: _this.props.builderBlock, dataOnly: _this.props.dataOnly }), _this.props.children))));
        }));
    };
