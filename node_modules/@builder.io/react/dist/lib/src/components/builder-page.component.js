...
var BuilderPage = /** @class */ (function (_super) {
    ...
    function BuilderPage(props) {
        ...
        _this.onContentLoaded = function (data, content) {
            ...
            if (data && data.jsCode && sdk_1.Builder.isBrowser) {
        ...
        _this.state = {
            ...
            state: Object.assign(_this.rootState, __assign(__assign(__assign(__assign({}, (_this.props.content && _this.props.content.data && _this.props.content.data.state)), { isBrowser: sdk_1.Builder.isBrowser, isServer: !sdk_1.Builder.isBrowser, _hydrate: props.hydrate, location: _this.locationState, deviceSize: _this.deviceSizeState, 
        ...
        if (sdk_1.Builder.isBrowser) {
            ...
            if (_this.props.content) {
                ...
                var content = _this.props.content.content || _this.props.content;
                _this.onContentLoaded(content === null || content === void 0 ? void 0 : content.data, content);
            }
        }
        return _this;
    }
    Object.defineProperty(BuilderPage.prototype, "name", {
        get: function () {
    ...
    Object.defineProperty(BuilderPage.prototype, "element", {
        get: function () {
            return this.ref;
        },
        enumerable: true,
    ...
    Object.defineProperty(BuilderPage.prototype, "builder", {
        get: function () {
    ...
    BuilderPage.prototype.getHtmlData = function () {
        var id = (this.props.content && this.props.content.id) || this.props.entry;
        var script = id &&
    ...
    Object.defineProperty(BuilderPage.prototype, "device", {
    ...
    BuilderPage.renderInto = function (elementOrSelector, props, hydrate, fresh) {
        ...
        if (shouldHydrate && element) {
            ...
            var val_1 = react_dom_1.default.render(react_1.default.createElement(BuilderPage, __assign({}, props)), useEl, useEl.builderRootRef);
            useEl.builderRootRef = val_1;
            return val_1;
        }
        var val = react_dom_1.default.render(react_1.default.createElement(BuilderPage, __assign({}, props)), useEl, useEl.builderRootRef);
    ...
    BuilderPage.prototype.notifyStateChange = function () {
    ...
    BuilderPage.prototype.getCssFromFont = function (font, data) {
    ...
    BuilderPage.prototype.ensureFontsLoaded = function (data) {
    ...
    Object.defineProperty(BuilderPage.prototype, "data", {
        get: function () {
            var _a;
            var data = __assign(__assign(__assign({}, (this.props.content && ((_a = this.props.content.data) === null || _a === void 0 ? void 0 : _a.state))), this.props.data), this.state.state);
    ...
    BuilderPage.prototype.componentDidUpdate = function (prevProps) {
        var _this = this;
        // TODO: shallow diff
    ...
    BuilderPage.prototype.checkStyles = function (data) {
        if (this.styleRef) {
            var css = this.getCss(data);
            if (this.styleRef.innerHTML !== css) {
                this.styleRef.innerHTML = css;
            }
        }
    };
    BuilderPage.prototype.reload = function () {
        this.setState({
            key: this.state.key + 1,
        });
    };
    Object.defineProperty(BuilderPage.prototype, "content", {
        get: function () {
    ...
    Object.defineProperty(BuilderPage.prototype, "useContent", {
        get: function () {
    ...
    BuilderPage.prototype.render = function () {
        ...
        react_1.default.createElement(WrapComponent, { className: "builder-component " + (contentId ? "builder-component-" + contentId : ''), "data-name": this.name, "data-source": "Rendered by Builder.io on " + new Date().toUTCString(), key: this.state.key, ref: function (ref) { return (_this.ref = ref); } },
            react_1.default.createElement(builder_meta_1.BuilderMetaContext.Consumer, null, function (value) { return (react_1.default.createElement(builder_meta_1.BuilderMetaContext.Provider, { value: typeof _this.props.ampMode === 'boolean'
                ...
                react_1.default.createElement(builder_async_requests_1.BuilderAsyncRequestsContext.Consumer, null, function (value) {
                    ...
                    return (react_1.default.createElement(builder_content_component_1.BuilderContent, { isStatic: _this.props.isStatic || sdk_1.Builder.isStatic, key: ((_a = _this.props.content) === null || _a === void 0 ? void 0 : _a.id) ||
                            ('content' in _this.props ? 'null-content-prop' : 'no-content-prop'), builder: _this.builder, ref: function (ref) { return (_this.contentRef = ref); }, 
                        // TODO: pass entry in
                        contentLoaded: function (data, content) { return _this.onContentLoaded(data, content); }, options: __assign(__assign(__assign(__assign({ key: key, entry: _this.props.entry }, (content && { initialContent: [content] })), (!content && 'content' in _this.props && { initialContent: [] })), (_this.props.url && { url: _this.props.url })), _this.props.options), inline: _this.props.inlineContent || (!sdk_1.Builder.isEditing && 'content' in _this.props), contentError: _this.props.contentError, modelName: _this.name || 'page' }, function (data, loading, fullData) {
                        var _a;
                        ...
                        return data ? (react_1.default.createElement("div", { "data-builder-component": _this.name, "data-builder-content-id": fullData.id, "data-builder-variation-id": fullData.testVariationId || fullData.variationId || fullData.id },
                            _this.getCss(data) && (react_1.default.createElement("style", { ref: function (ref) { return (_this.styleRef = ref); }, className: "builder-custom-styles", dangerouslySetInnerHTML: {
                                    __html: _this.getCss(data),
                                } })),
                            react_1.default.createElement(builder_store_1.BuilderStoreContext.Provider, { value: __assign(__assign({}, _this.state), { rootState: _this.rootState, state: _this.data, content: fullData, renderLink: _this.props.renderLink }) },
                                react_1.default.createElement(builder_blocks_component_1.BuilderBlocks, { key: String(!!((_a = data === null || data === void 0 ? void 0 : data.blocks) === null || _a === void 0 ? void 0 : _a.length)), emailMode: _this.props.emailMode, fieldName: "blocks", blocks: data.blocks })))) : loading ? (react_1.default.createElement("div", { "data-builder-component": _this.name, className: "builder-loading" }, _this.props.children)) : (react_1.default.createElement("div", { "data-builder-component": _this.name, className: "builder-no-content" }));
                    }));
                }))); })));
    };
    ...
    ], BuilderPage.prototype, "notifyStateChange", null);
    __decorate([
...
//# sourceMappingURL=builder-page.component.js.map