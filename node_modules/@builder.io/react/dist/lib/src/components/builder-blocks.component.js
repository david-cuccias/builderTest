...
var BuilderBlocks = /** @class */ (function (_super) {
    ...
    BuilderBlocks.prototype.render = function () {
        ...
        core_1.jsx(TagName, { className: 'builder-blocks' +
                (this.noBlocks ? ' no-blocks' : '') +
                (this.props.child ? ' builder-blocks-child' : '') +
                (this.props.className ? ' ' + this.props.className : ''), "builder-type": "blocks", "builder-path": sdk_1.Builder.isIframe ? this.path : undefined, css: __assign(__assign({}, (!this.props.emailMode && {
                display: 'flex',
