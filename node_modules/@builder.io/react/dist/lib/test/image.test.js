...
var removeRenderIdRegex = /data-source="[\s\S]*?"/g;
describe('Image', function () {
    ...
    it('Amp image', function () {
        ...
        var renderedBlock = server_1.renderToStaticMarkup(React.createElement(builder_react_1.BuilderPage, { model: "page", ampMode: true, content: {
                data: {
                    blocks: [imageBlock],
                },
    ...
    it('with responsive styles', function () {
        ...
        var renderedBlock = server_1.renderToStaticMarkup(React.createElement(builder_react_1.BuilderPage, { model: "page", content: {
                data: {
                    blocks: [imageBlock],
                },
            } })).replace(removeRenderIdRegex, '');
